...
def test_detailed_comparison():
    ...
    if bld_response and auto_response:
        ...
        if 'response' in common_fields:
            print(f"Both have 'response' field: BLD='{bld_response['response']}', Auto='{auto_response['response']}'")
...
def main():
    ...
    print(f"BlenderAutoMCP (9876): {'✅ RUNNING' if auto_running else '❌ NOT RUNNING'}")
