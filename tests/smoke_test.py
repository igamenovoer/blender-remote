...
def run_smoke_test():
    ...
    try:
        ...
        blender_auto_ok = wait_for_service(
            BLENDER_AUTO_PORT, service_name="BlenderAutoMCP"
        )
        ...
        results = {
            ...
            "blender_auto_basic": test_service_basic(
                BLENDER_AUTO_PORT, "BlenderAutoMCP"
            ),
            "bld_remote_api": test_blender_api_access(
                BLD_REMOTE_PORT, "BLD_Remote_MCP"
            ),
            "blender_auto_api": test_blender_api_access(
                BLENDER_AUTO_PORT, "BlenderAutoMCP"
            ),
        }
