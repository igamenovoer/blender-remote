...
def main():
    ...
    print(f"BLD_Remote_MCP (6688): {'✅ RUNNING' if bld_remote_running else '❌ NOT RUNNING'}")
    print(f"BlenderAutoMCP (9876): {'✅ RUNNING' if blender_auto_running else '❌ NOT RUNNING'}")
    ...
    if not blender_auto_running:
        print("❌ BlenderAutoMCP is not running. Cannot use it to start BLD_Remote_MCP.")
